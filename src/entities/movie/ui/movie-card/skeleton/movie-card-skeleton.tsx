...
export function MovieGridSkeleton({ viewMode, count = 12 }: MovieGridSkeletonProps) {
  return (
    <div
      className={
        viewMode === "grid"
          ? "w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6"
