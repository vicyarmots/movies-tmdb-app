import { TMDBMovieDetail, TMDBMovieTransformed } from "@/processes/api/types";
...
import { Calendar, Clock, Eye, EyeOff, Share, Star } from "lucide-react";
          ...
          {movie.vote_average && (
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">{movie.vote_average}/10</span>
              </div>
            </div>
          )}
